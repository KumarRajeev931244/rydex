...
import { Bike, Bus, Car, CarTaxiFront, ChevronLeft, ChevronRight, Sparkle, Truck } from 'lucide-react'
...
const VEHICLE_CATEGORIES = [
    ...
    {title:"Trucks", desc:"Heavy & commerical transport", Icon:Truck, tag:"Cargo" },
]
            ...
            <div className="max-w-7xl mx-auto">
                ...
                >
                    <div>
                        ...
                        <span className="relative inline-block">Categories</span>
                        <motion.div
                        initial={{scaleX:0}}
                ...
                <div className="relative">
                    <div className="flex gap-5 pt-20 overflow-x-auto scroll-smooth pb-4 ox-1"
                    ref = {sliderRef} 
                    ...
                    >
                        {
                            VEHICLE_CATEGORIES.map((c,i) =>{
                                ...
                                return (
                                    ...
                                    whileHover={{y:-8}}
                                    className="group relative min-w-[220;x] sm:min-w-[260px] flex-shrink-0 cursor-pointer"
                                    >
                                        <motion.div
                                        animate={{
                                        ...
                                        className="inline-flex items-center gap-1.5 border text-[9px] font-black uppercase tracking-[0.18em] px-2.5 py-1.5 rounded-full mb-5"
                                            >
                                                <Sparkle size={8}/>{c.tag}
                                            </motion.div>

                                            <motion.div
                                            animate={{
                                                backgroundColor: isHovered ? "rgba(255,255,255,0.1)" : "#f4f4f5",
                                                border:isHovered ? "rgba(255,255,255,0.15)" : "#e4e4e7"
                                            }}
                                            ...
                                            >
                                                ...
                                                >
                                                    <c.Icon strokeWidth={1.4} size={24}/>
