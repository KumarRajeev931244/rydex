    ...
    return(
                                ...
                                >
                                    <div className="p-5">
                                        ...
                                        {userData.role!="partner" && (
                                            <div className='w-full flex items-center gap-3 py-3 hover:bg-gray-100 rounded-xl cursor-pointer'>
        ...
        <AnimatePresence>
            {menuOpen && (
                ...
                className="fixed top-[85px] left-1/2 -translate-x-1/2 w-[92%] bg-[#0b0b0b] rounded-xl shadow-2xl z-40 md:hidden overflow-hidden"
                >
