...
import { BarChart2, Stars, TrendingDown, TrendingUp, Zap } from "lucide-react";
...
function PartnerEarning() {
    ...
    const deltaPact = yesterDay ? Math.abs(Math.round((delta/yesterDay.earnings) * 100)):0
        ...
        <div className="flex items-start justify-between mb-6 flex-wrap gap-4">
            ...
            <div className="text-right">
                ...
                <div className={`flex items-center justify-end gap-1 text-xs font-semibold mt-1 ${deltaPositive ? "text-emerald-600": "text-rose-500"}`}>
                    ...
                    <span>{deltaPact}% vs yesterday</span>
                </div>
            </div>
        </div>
