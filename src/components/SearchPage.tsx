  ...
  return (
    <div className="min-h-screen bg-zinc-100 text-zinc-900 overflow-x-hidden">
      ...
      <motion.div
        ...
        className="relative z-20 -mt-10 bg-white rounded-t-[28px] border-t border-zinc-200 shadow-[0_-80px_40px_rgba(0,0,0,0.08)] pt-5 pb-20 min-h-[52vh] "
      >
            ...
            {!loading && vehicles.length == 0 && (
              ...
              >
                ...
                <p className="text-zinc-400 text-sm max-w-xs leading-relaxed">
                  {meta.label || "vehicles"} drivers are available near your
                  pickup right now.
                </p>
                <motion.button
                  whileTap={{ scale: 0.95 }}
