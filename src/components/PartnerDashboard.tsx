                       ...
                       <div className="relative flex justify-between">
                        {STEPS.map((s,index) => {
                             ...
                             return(
                                ...
                                onClick={()=>goToStep(s)}
                                >
                                    <div className={`w-14 h-14 rounded-full flex items-center justify-center border-2 transition-all ${completed ? "bg-black text-white border-black" : active ? "border-black bg-white" : "border-gray-300 text-gray-400 bg-white"}`}>
