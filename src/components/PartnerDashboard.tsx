...
import { ArrowRight, Check, Clock, Clock1, Clock2, Lock, Video } from "lucide-react";
...
const STEPS: Step[] = [
  ...
  { id: 2, title: "Documents", route: "/partner/onboarding/document" },
      ...
      <div className="max-w-7xl mx-auto space-y-16">
        ...
        <div className="bg-white rounded-3xl p-10 shadow-xl border overflow-x-auto">
          <div className="relative min-w-200">
            <div className="absolute top-7 w-full h-0.75 bg-gray-200 rounded-full" />
            <motion.div
            ...
            <div className="relative flex justify-between">
              {STEPS.map((s, index) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`w-14 h-14 rounded-full flex items-center justify-center border-2 transition-all ${completed ? "bg-black text-white border-black" : active ? "border-black bg-white" : "border-gray-300 text-gray-400 bg-white"}`}
                    >
                      {completed ? (
                        <Check size={20} />
                      ) : locked ? (
