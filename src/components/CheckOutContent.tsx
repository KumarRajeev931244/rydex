...
function CheckOutContent() {
  ...
  const fetchActiveBooking = async() => {
    ...
    try {
      ...
      console.log("fetchActiveBooking:",data);
  ...
  const handleRequestBooking = async () => {
    ...
    try {
      ...
      mobileNumber:mobile,
        ...
        console.log("handleRequestBooking:",data);
        setBooking(data)
        setLoading(false)
      ...
      <div className="relative max-w-6xl mx-auto z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          <motion.div
            ...
            className="bg-white rounded-3xl border border-zinc-200 overflow-hidden shadow-[0_4px_ 24px_rgba(0,0,0,0.7)]"
          >
          ...
          <motion.div
            ...
            className="bg-white rounded-3xl border border-zinc-200 overflow-hidden shadow-[0_4px_ 24px_rgba(0,0,0,0.7)] flex flex-col"
          >
            <div className="h-1 bg-zinc-900" />
              ...
              <AnimatePresence mode="wait">
                                ...
                                [
                                    {icon:<Clock size={14}/>, text:"Driver will respond within 2 minutes"},
                                     {icon:<Shield size={14}/>, text:"Verified & insured drivers only"},
                                      {icon:<CreditCard size={14}/>, text:"Pay after drivers accepts"},
                                ].map((item,i) => (
                ...
                {status=="requested" && (
                 ...
                 {status == "awaiting_payment" && (
                  <motion.div
                    ...
                    exit={{ opacity: 0 }}
                    transition={{ duration: 0.35 }}
                    className="flex flex-col flex-1 justify-center items-center gap-5 text-center"
                  >
                    <motion.div
                    initial={{  scale:0}}
                    animate={{  scale:1 }}
                ...
                {status == "confirmed" && (
                  <motion.div
                    ...
                    className="flex flex-col flex-1 gap-6 items-center text-center"
                  >
                   ...
                   >
                    ...
                    animate={{ opacity: 0, scale:2.2 + i*0.6 }}
                   ...
                   <div>
                    ...
                    className="text-sm font-medium text-zinc-400 max-w-xs"
