...
import { ArrowLeft, Car, CheckCircle, Clock, FileText, FileTextIcon, Landmark, ShieldCheck, XCircle } from 'lucide-react'
                ...
                <div className="space-y-8">
                    ...
                    {data?.partnerStatus=="pending" && (
                        ...
                        >
                            ...
                            <div className='flex flex-col gap-4'>
                                <button className='py-3 rounded-2xl  font-semibold hover:bg-gray-100   transition border' onClick={() => setShowReject(true)}>
                                    Reject
                                </button>
                            </div>
