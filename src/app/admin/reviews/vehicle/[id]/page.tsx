        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="max-w-7xl mx-auto px-4 h-16 flex items-center gap-4">
                ...
                <div className="flex-1">
                    <div className='font-semibold text-lg text-black'>{data?.owner?.name.toUpperCase()}</div>
            ...
            <main className="max-w-7xl mx-auto px-6 py-12 grid lg:grid-cols-2 gap-12">
                ...
                <div className="space-y-8">
                    ...
                    >
                        ...
                        <div className="flex justify-between text-sm">
                            <span className='text-gray500 text-sm'>Price per km</span>
                            <span className='font-semibold flex items-center'><IndianRupee size={13}/>{data?.pricePerKm || "0"}</span>
                        </div>
                        <div className="flex justify-between text-sm">
                            <span className='text-gray500 text-sm'>Waiting Charge</span>
