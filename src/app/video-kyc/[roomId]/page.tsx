...
import { CheckCheck, CheckCircle, Mic, MicOff, PhoneOff, Video, VideoOff, X, XCircle } from "lucide-react";
...
export default function Page(){
    ...
    const handleApprove =async(action:string) => {
        ...
        const handleRejection =async(action:string) => {
            setRLoading(true)
        try {
    ...
    return(
        <div className="min-h-screen bg-black text-white flex flex-col">
            ...
            <Image src={"/rydex.png"} alt="logo" width={100} height={100} priority />
                        ...
                        <div className="space-y-8 text-center lg:text-left">
                            ...
                            <div className="flex justify-center lg:justify-start gap-6">
                                ...
                                className={`w-14 h-14 rounded-full flex items-center justify-center transition ${
                                    isCameraOn ? "bg-white text-black" : "bg-white/10 border border-white/20"
                                }` }
                                ...
                                className={`w-14 h-14 rounded-full flex items-center justify-center transition ${
                                    isMicOn ? "bg-white text-black" : "bg-white/10 border border-white/20"
                                }` }
                            ...
                            disabled={loading}
                            >{loading?"Connecting...": "Join secure Call"}</button>
                        </div>
                    </div>
