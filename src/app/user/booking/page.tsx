...
import { Bike, CalendarHeart, Car, ChevronRightIcon, IndianRupee, Loader2, MapPin, Navigation, Phone, Truck, User } from "lucide-react";
...
function page() {
  ...
  console.log("booking lenght:", booking);
  const filteredBooking =
    selectStatus === "All"
      ? booking
      : booking.filter((b) => b.bookingStatus === selectStatus.toLowerCase());
  return (
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm mt-1">
                  {" "}
                  {booking?.length}
                  {booking.length === 1 ? " ride" : " rides"} assigned to
                  you{" "}
                </p>
              </div>
            </div>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="flex justify-between items-center mb-6">
            <div className="text-sm text-gray-500">
              showing {filteredBooking.length} booking
            </div>
            <select
          ...
          {!loading && filteredBooking.length == 0 && (
            <div
            ...
            >
              ...
              <p className="text-gray-500 text-sm mt-1">
                when customers book rides, they will appear here
              </p>
            </div>
          )}
          {!loading && filteredBooking.length > 0 && (
            <div className="space-y-4">
              {filteredBooking.map((b, i) => (
                <motion.div
                  key={i}
                      ...
                      <div className="flex-1">
                        <div className="flex items-center justify-between">
                          <h3 className="font-semibold text-gray-900">
                            {b.driver.name.toUpperCase() || "Driver"}{" "}
                          </h3>
                          <span
...
{/* address */}
                    <div className=" p-4 space-y-3">
                        <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                                <span className="text-xs font-bold text-green-600 uppercase tracking-wider">PICK UP</span>
                                <p className="text-sm text-gray-700 mt-0.5 leading-relaxed"> {b.pickUpAddress} </p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1">
                                <span className="text-xs font-bold text-red-600 uppercase tracking-wider">DROP</span>
                                <p className="text-sm text-gray-700 mt-0.5 leading-relaxed"> {b.dropAddress} </p>
                            </div>
                        </div>
                    </div>
