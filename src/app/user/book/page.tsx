...
const VEHICLE = [
  { id: "bike", Icon: Bike, label: "Bike", desc: "Quick & Affordable" },
  { id: "auto", Icon: Car, label: "Auto", desc: "Everyday rides" },
  { id: "car", Icon: Car, label: "Car", desc: "Comfort rides" },
  { id: "Loading", Icon: Truck, label: "Laoding", desc: "Small cargo" },
  { id: "Truck", Icon: Truck, label: "Truck", desc: "Heavy transport" },
];
...
function Page() {
  ...
  const [pickUpSuggesstion, setPickUpSuggesstion] = useState<Place[]>([]);
  const [dropSuggesstion, setDropSuggesstion] = useState<Place[]>([]);
  ...
  const suggesstion=(p:Place)=>[p.name,p.city,p.state,p.country].filter(Boolean).join(",")
  ...
  const searchAddress = async(q:string,setResults:(r:Place[])=>void,restrict?:string | null) => {
    ...
    lng:f.geometry.coordinates[0]
        ...
        console.log("serachAddressError:",error);
        setResults([])
                ...
                <div className="relative z-20">
                    <div className="flex items-center gap-3 px-4 py-3.5 focus-within:bg-white rounded-t-2xl transition-colors">
                        <div className="flex flex-col items-center flex-shrink-0">
                            <div className="w-3 h-3 rounded-full bg-zinc-900 border-white shadow"/>
                        ...
                        onChange={(e)=>{ 
                            ...
                            searchAddress(e.target.value,setPickUpSuggesstion)
                        ...
                        >
                          {pickUpSuggesstion.map((p,i) => (
                            ...
                            >
                              ...
                              <span className="text-sm text-zinc-800 font-medium truncate">{suggesstion(p)}</span>
                ...
                <div className="relative z-10">
                    <div className="flex items-center gap-3 px-4 py-3.5 focus-within:bg-white rounded-t-2xl transition-colors">
                        ...
                        onChange={(e)=>{ 
                            ...
                            searchAddress(e.target.value,setDropSuggesstion,pickUpCountry)
